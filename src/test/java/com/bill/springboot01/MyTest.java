...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("D:\\Workspace\\springboot01\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/springboot01?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.bill").setMapper("mapper")
